...
public class PhoneResource {
	...
	@GET
	public Collection<Phone> getAll(@QueryParam("order") String order, @QueryParam("q") String q, @QueryParam("limit") Integer limit, @QueryParam("n") Integer offset,
			@QueryParam("name") String name, @QueryParam("price")Double price, @QueryParam("ReleaseDate") LocalDate rd, @QueryParam("Size")String sz, @QueryParam("resolution") String resolution)
	{
		...
		for (Phone phone : repository.getAllPhones()) {
			if ((q == null
					...
					)&&(name == null|| phone.getName().toLowerCase().contains(name.toLowerCase())
					)&&(price==null||phone.getPrice()==price
					)&&(rd==null||phone.getReleaseDate()==rd
					)&&(sz==null||phone.getSize().toLowerCase().contains(sz.toLowerCase())
					)&&(resolution==null||phone.getResolution().toLowerCase().contains(resolution.toLowerCase())))
					{
